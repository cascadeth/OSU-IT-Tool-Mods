...
couldn't resist the puns...).  Namely: make the forms not force you to scroll 
all the time to set fields when editing tickets.  Like seriously, having to 
scroll to set the *STATUS* field is an incredibly poor design choice, as that 
is something that needs to be set on every ticket.
